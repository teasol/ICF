...
> [!IMPORTANT]
> **활성 구성은 v108 — 학습 파라미터 0 (§139·§140·§142·§152).** 아래 Active-1~6은 **학습을 포함하던 직전
...
>        ⚠️ v108: 거리를 **상위 32 PCA 방향**에서 재고, 16-d abundance **전체**를
>        class-balanced ridge로 읽는다 (v107은 raw 1536 + 극단 2개 token, §150·§152)
