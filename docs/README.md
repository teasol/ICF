...
**Active baseline**: **v98** (`donor_shift_scale` 0.15) — SEAL 10-task macro **1-GPU 8 seed(42–49) 평균 0.6852**
(§131, 사용자 결정). ⚠️ **"v83보다 낫다"가 아니라 "8 seed로 측정된 유일한 arm"이라는 뜻**이며,
v83 4 seed 0.6880과 **직접 빼면 안 된다**. 실행 중: 없음.
