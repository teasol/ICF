...
| **부분 fold로 스크리닝하고 부호를 주장** | brca TP53 첫 3 fold에서 K=256은 −0.037로 보였으나 50 fold 전체로는 −0.0022였다. fold 부분집합은 §125-1의 1-seed 스크리닝과 같은 물건이다 — 크게 나쁜 것을 배제하는 데만 쓸 것 (§142-6) |
