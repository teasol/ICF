...
| **v107 후보 = v106에 K=256** | v106과 동일, `covariance_sketch_dim` 128→256만 | **0.6945** | **0.00000** | **권고, 사용자 확정 대기 (§142)**. SEAL 10 +0.0081 (t=2.98, 8/10), 홀드아웃 7 +0.0069, 전체 17 **+0.0076 (t=3.01, 12/17)**. 런타임 동일(24→25초). K는 v106에서 처음으로 **평가 시점 노브**가 됐다 |
| **v106 = within PCA + 고정 head** | 사영=fold context의 within-slide PCA, head=상수 3개, **학습 param 0** | **0.6864** | **0.00000** | **활성 구성 (§139, 사용자 결정)**. 정식 경로. v98(42–45) 대비 −0.0037 (t=−1.08, 측정 불가) — macro를 내주고 학습·시드 반복 제거 |
