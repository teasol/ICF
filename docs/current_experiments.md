...
| v101 donor_shift 0 | `donor_shift_scale` 0.35→**0.0** 단독 | — | — | **학습 중** — v100 교란 분리 (§127-6) |
...
4i-00. ⚠️⚠️ **"nuisance"는 한 종류가 아니다 (§126-3 → §127-4로 수정) — 지금 최전선.**
   §126-3의 단조 가설("적을수록 좋다")은 **v100이 반증**했다(−0.0076, t=−3.59, 0/4). 수정된 그림:
   **bag 수준(`donor_shift_scale`)은 역U자로 최적 ~0.15**(v100 0.0 −0.0076 / **v98 0.15 +0.0021
   4/4** / v83 0.35 / v94 0.75 −0.0043), **cell 노이즈(`observation_noise`)는 정규화라 끄면 해롭고**
