...
| **v107 = v106에 K=256** | v106과 동일, K 128→256만 | **0.6945** | **0.00000** | **활성 구성 (§142, 사용자 결정)**. `scripts/eval_v107.sh`. SEAL 10 +0.0081 (t=2.98, 8/10), 홀드아웃 7 +0.0069, 전체 17 **+0.0076 (t=3.01, 12/17)**. 런타임 동일(24→25초). K는 v106에서 처음으로 **평가 시점 노브**가 됐다 |
