...
⚠️ **에피소드 모양 축(§115)의 현재 상태**: bag 축 **닫힘**(+0.0020, §119-1). cell 축은 양방향
모두 음수(v91 −0.0068 / v92 −0.0098)라 **단조 레버가 아니다** — 다만 v92는 context 축소 교란이
있어 깨끗한 검정이 남아 있다(§121). 클래스 비율 축은 **기각**(v90, §118).
