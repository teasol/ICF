...
| **v109 = CV offdiag + CT k-means @0.7** | CV는 off-diagonal 32,640만, CT는 k-means token(Lloyd 30) + weight 0.7 | **0.7027** | **0.00000** | **활성 구성 (§158, 사용자 결정)**. `scripts/eval_v109.sh`. 홀드아웃 0.6042, 전체 17 **+0.0096 (13/17)** — 세션 최고 부호 일치. 단독 +0.0070·+0.0030이 **가법적**(예측 0.6624 vs 실측 0.6621). ABMIL 대비 −0.0243 |
