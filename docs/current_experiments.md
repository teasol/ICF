...
| v100 nuisance min | `donor_shift`·`donor_component_shift`·`observation_noise` → 0 | — | — | **학습 중** — §126-3 가설의 직접 검정 (예측: Δ>+0.0021, 4/4) |
...
4i-00. ⚠️⚠️ **nuisance 가설 (§126-3) — 지금 최전선.** arm 5개가 부호까지 일치한다: 합성 학습에
   **nuisance 변동을 더하면 나빠지고 빼면 좋아진다**(v98 −nuisance +0.0021 4/4 / v94 +nuisance
   −0.0043 / v90 −0.0053 / v95 −0.0086 / v99 −0.0094). §115·§123의 처방이 전부 "실제와 닮게 =
   nuisance 추가"였고 **방향이 반대였다.** P1 축은 단조(0.15/0.35/0.75 → +0.0021/0/−0.0043)다.
   ⚠️ 반례 후보: v86(noise ↑)이 +0.0004로 미세 양수. 검정 중: v100(nuisance 최소화).
