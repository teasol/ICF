...
| **v108 = v107의 CT 교체** | CT 거리를 32-d PCA 부분공간에서 재고 16-d abundance 전체를 ridge로 읽음 | **0.6967** | **0.00000** | **활성 구성 (§152, 사용자 결정)**. `scripts/eval_v108.sh`. SEAL 10 +0.0022, 홀드아웃 7 +0.0057, 전체 17 **+0.0037 (11/17)**. ⚠️ t 미보고(결정론적, §151-1). PCA·ridge **단독은 각각 +0.0019/+0.0008** — 반드시 함께 (§150) |
