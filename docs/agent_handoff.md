...
0.005→0.01)을 v83 기준으로 재측정한 결과 완전 무효과**였다(+0.0004, t=0.71, 3/4 — §112) — §105-6의
옛 +0.0104는 지금 baseline/레짐에서 재현되지 않는다. 다음은 rare 축(§105-6에서 비슷한 크기였던
+0.0103) 재검증이다. 직전 baseline **v82 Medium**(1-GPU 4 seed 0.6835)은 historical. ⚠️ v83의
