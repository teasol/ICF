# [ARCHIVED v21] Signal-Aware Retrieval investigation log

> [!WARNING]
> **이 문서는 v21 retrieval 시대의 기록이며 더 이상 SSOT가 아닙니다.**
> 2026-07-29 v22에서 retrieval 계층이 코드베이스에서 완전히 제거되었습니다.
> 현재 상태는 [`../current_status.md`](../current_status.md),
> 현재 실험 프로토콜은 [`../current_experiments.md`](../current_experiments.md)를 참고하세요.
>
> 여기 기록된 config/스크립트 경로 상당수는 `configs/archive/v21_retrieval/`
> 및 `scripts/archive/v21_retrieval/`로 이관되었고, 여기 언급된 체크포인트는
> 모두 v21이라 v22 코드로 로드되지 않습니다 (버전 게이트가 거부).
