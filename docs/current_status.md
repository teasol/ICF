...
> [!IMPORTANT]
> **활성 구성은 v109(§158, 사용자 결정) — 학습 파라미터 0이다.**
> ```
...
> CT   : 32 PCA 방향에서 거리 → k-means token 16개(Lloyd 30회) → class-balanced ridge
> 정식 경로 SEAL 10-task macro = 0.7027,  홀드아웃 7 = 0.6042,  seed std 0.00000
>
...
>
> ⚠️ v109의 0.7027과 v98 8 seed 0.6852를 **빼지 말 것** — 시드 집합이 다르다(§131-1).
> ⚠️ v106(0.6864)·v107(0.6945)·v108(0.6967)은 historical이다.
