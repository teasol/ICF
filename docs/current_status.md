...
**Last updated**: `2026-07-28 11:00:00 KST`  
**Latest Commit**: `eada458` (`feat(pretrain): implement 2-pass signal-aware retrieval streaming and large candidate pool (N=96) context scaling`)  
