...
**Last updated**: `2026-08-16` (nhn-NEXGEM-claude 12:51) — §137까지. baseline은 **v98 8 seed 0.6852**(§131). ⚠️⚠️ **§136–§137이 그림을 바꿨다: 학습 파라미터 0짜리 모델(PCA 사영 + 고정 3상수 head)이 196,621개를 학습한 것과 대등하고 seed std가 0이다.** 필요한 것은 '학습'이 아니라 '데이터 적응성'이었다. **정식 경로 재측정이 남았다(§137-6).**
