...
**Last updated**: `2026-08-15` (nhn-NEXGEM-claude 21:38) — §131까지. **baseline이 v98 8 seed(0.6852)로 교체**됐다(§131, 사용자 결정 — "더 낫다"가 아니라 "가장 잘 측정됐다"). ⚠️ **4 seed로는 0.012 미만을 판별할 수 없다** — 과거 "미판정"은 "효과 없음"이 아니라 **"측정 불가"**다(§131-2·§131-3).
