...
> [!IMPORTANT]
> **활성 구성은 v108(§152, 사용자 결정) — 학습 파라미터 0이다.**
> ```
...
> 정식 경로 SEAL 10-task macro = 0.6967,  seed std 0.00000 (완전 결정론적)
>
...
>
> ⚠️ v108의 0.6967과 v98 8 seed 0.6852를 **빼지 말 것** — 시드 집합이 다르다(§131-1).
> ⚠️ v106(K=128, 0.6864)·v107(CT raw+two-token, 0.6945)은 historical이다.
