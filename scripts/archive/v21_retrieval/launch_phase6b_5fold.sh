...
echo "=== Launching Phase 6b: ICI 5-Fold CV Fine-Tuning with Model-Internal Signal-Aware Retrieval ==="

for FOLD in {0..4}; do
    RUN_KIND="v21_ici_finetune_phase6b_f${FOLD}"
    CONFIG="configs/train_v21_ici_finetune_signalaware_fold${FOLD}.yaml"
