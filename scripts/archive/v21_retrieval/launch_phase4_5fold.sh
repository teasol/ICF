...
PRETRAINED_CKPT="${PROJECT_ROOT}/checkpoints/20260728_003034/v21_hard_retrieved/epoch=012-val_ce_loss=0.6803.ckpt"

echo "=== Launching Phase 4: Full ICI 5-Fold CV Fine-Tuning ==="

for FOLD in {0..4}; do
    RUN_KIND="v21_ici_finetune_f${FOLD}"
