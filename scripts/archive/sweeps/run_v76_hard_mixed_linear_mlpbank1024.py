"""Train and evaluate the 50:50 linear + MLP-1024 Hard arm on GPUs 0-3."""
...
CONFIG = "configs/archive/v69_v76_relation/train_v76_hard_mixed_linear_mlpbank1024_1536.yaml"
RUN_ROOT = ROOT / "checkpoints/20260812_v76_hard_mixed_linear_mlpbank1024"
LOG_ROOT = ROOT / "logs/20260812_v76_hard_mixed_linear_mlpbank1024"
GPUS = (0, 1, 2, 3)
TASKS = (
...
def main() -> None:
    ...
    print(f"=== TRAIN START mixed50_mlpbank1024 GPUs={GPUS}", flush=True)
    ...
    workers = [
        subprocess.Popen(
            ["bash", "scripts/eval_seal_tasks.sh", str(gpu), str(checkpoint),
             CONFIG, "v76_hard_mixed50_mlpbank1024_best", *tasks], cwd=ROOT,
        )
    ...
    print("=== EVAL END mixed50_mlpbank1024", flush=True)
