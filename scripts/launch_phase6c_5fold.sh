...
echo "=== Launching Phase 6c: ICI 5-Fold CV Fine-Tuning, NO Retrieval (Full Context Baseline) ==="

for FOLD in {0..4}; do
    RUN_KIND="v21_ici_finetune_phase6c_f${FOLD}"
    CONFIG="configs/train_v21_ici_finetune_fullcontext_fold${FOLD}.yaml"
