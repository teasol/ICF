...
CKPT="${ICF_V107_CKPT:-$(ls checkpoints/20260815_113422/v98_p1_reverse_seed42/periodic-epoch=049*.ckpt)}"
CONFIG="${ICF_V107_CONFIG:-configs/train_v98_p1_reverse_1536_1gpu.yaml}"
